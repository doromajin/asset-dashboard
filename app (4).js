...
(function () {
  ...
  function calcSim() {
    ...
    // 1000万達成で25歳セクション↔30歳セクション入れ替え
    var sec25 = $('sim-25-section');
    var sec30 = $('sim-30-section');
    if (cur >= GOAL_25) {
      if (sec25) sec25.style.display = 'none';
      if (sec30) {
        sec30.style.display = 'contents';
      ...
      if (sec25) sec25.style.display = 'contents';
      if (sec30) sec30.style.display = 'none';
    }
